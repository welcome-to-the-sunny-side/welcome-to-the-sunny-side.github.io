...
Hint: Like we've already shown earlier, the optimal path through $k$ is going to travel along $P$ for some prefix, hop off it once, visit $k$, and hop back onto $P$ for the remaining suffix. Those two "hop points" can be chosen as $g$ and $h$.  
