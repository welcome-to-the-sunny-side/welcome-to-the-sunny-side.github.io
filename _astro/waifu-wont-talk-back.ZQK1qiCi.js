...
I will only analyze non-platonic relationships here. I want to maintain some semblance of logical coherence, so I'll try to be precise in my assertions/conclusions. All views will be from a male perspective for obvious reasons.
...
Note: The current technical limitations of AI (especially extremely poor long term memory) aren't relevant to this blog, and even if they were, it wouldn't matter because I know nothing about how it all works. I am pretty sure they will be fixed in a couple of years anyways.
...
2. Societal problems: How does society function if a significant percentage of the male population can easily obtain the reward that previously motivated them to contribute in society? I don't know or care.
3. Effects on corporeal females: I think negative?
...
As I mentioned earlier, $m$ constructs $c(f)$ with significant influence from already acquired knowledge. Essentially, the relational framework in $m$'s mind (how $m$ defines a relation, what he considers important in a relation, what he expects from a relation) is going to be incompatible with the capabilities and limitations of the AI female. This is obviously because the relational framework drilled into his mind would optimize the functioning of $r(m, f)$, which is defined for corporeal females.

A manifestation of this incompatibility that comes to mind immediately is that most relational frameworks assume some degree of symmetry between the two entities engaged in the relation. Here, however, $m$ doesn't have anything to lose in his relation with $c(f)$, and also has god-like power over $f$'s actions. In particular, $m$ possesses the ability to create a new instance of $f$ at will, and to completely undo any actions $f$ performs introduces severe asymmetry in his relation with $c(f)$, making it unstable with respect to the relational framework in his mind (which is based on corporeal females). This is just one example of a fundamental assumption of the typical relational framework that gets violated by AI relations, you can think of 1e6 more if you really think about it.

How can these be fixed? We will require completely new relational frameworks. A much more exciting possibility is that AI becomes so smart that it finds a way to switch off the parts of our brain that enslave us to female affection. That is definitely the ideal scenario and I hope we reach there soon.`;export{e as default};
