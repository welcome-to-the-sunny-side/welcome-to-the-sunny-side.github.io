...
To optimize this to $O((n + m) \\log{n})$, we can simply observe that we can use a Djikstra's like approach here due to the monotone nature of the transitions.`;export{t as default};
