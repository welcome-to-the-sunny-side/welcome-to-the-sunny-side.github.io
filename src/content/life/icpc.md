...
While my teammates devoted themselves to problems that we had a way higher chance of solving, I turned to perhaps an even more potent addiction of mine - Square Root Decomposition. Looking back, this technique and I have always been a match made in heaven, as it often allows one to soothe his ego through the satisfaction of solving "hard" problems bashable by it, in exchange for the sweat and toil that the implementation and casework in overengineered solutions involving it require. This reminds me of a list of "hard" sqrt-bashable problems that I once maintained: [link](https://www.welcome-to-the-sunny-side.com/algo/misc/square_root_supremacy.html).
...
The pain barely registered as I slapped myself across the face hard.
