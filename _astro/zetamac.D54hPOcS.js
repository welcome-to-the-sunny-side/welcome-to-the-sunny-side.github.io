  ...
  <section id="settings" class="w-full max-w-3xl mx-auto flex flex-col justify-center items-center min-h-[70vh] space-y-8 py-8">
    ...
    <div class="w-full grid grid-cols-1 sm:grid-cols-2 gap-8">
      ...
      <label class="flex flex-col items-center gap-4 group">
        ...
        <div class="text-xs text-center space-x-1">
          (<input id="add-min1" type="number" value="2" class="w-12 text-center rounded bg-surface/70" />
          to
          <input id="add-max1" type="number" value="100" class="w-12 text-center rounded bg-surface/70" />)
          +
          (<input id="add-min2" type="number" value="2" class="w-12 text-center rounded bg-surface/70" />
          to
          <input id="add-max2" type="number" value="100" class="w-12 text-center rounded bg-surface/70" />)
        </div>
      </label>
      ...
      <label class="flex flex-col items-center gap-4 group">
        ...
        ">×</span>
        <div class="text-xs text-center space-x-1">
          (<input id="mul-min1" type="number" value="2" class="w-12 text-center rounded bg-surface/70" />
          to
          <input id="mul-max1" type="number" value="12" class="w-12 text-center rounded bg-surface/70" />)
          ×
          (<input id="mul-min2" type="number" value="2" class="w-12 text-center rounded bg-surface/70" />
          to
          <input id="mul-max2" type="number" value="100" class="w-12 text-center rounded bg-surface/70" />)
        </div>
      </label>
    ...
    <div>
      <label class="font-medium flex items-center gap-2">Duration (seconds):
        <input id="duration" type="number" min="5" max="600" value="120" class="w-24 text-center rounded bg-surface/70" />
      </label>
    </div>
