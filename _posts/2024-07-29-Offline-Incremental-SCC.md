...
- [Algorithm](#algorithm)
  ...
  - [Answering Queries](#answering-queries)
    - [Queries based on number of edges added](#queries-based-on-number-of-edges-added)
    - [Queries based on nodes](#queries-based-on-nodes)
- [Complexity Analysis](#complexity-analysis)
- [Example Problems](#example-problems)
  - [Problem L, GP of Zheijang](#1-problem-l-grand-prix-of-zheijang-open-cup-2018-19)
  - [CF1989F](#2-cf-1989f)
  - [ONTAK 2009 Godzilla](#3-ontak-2009-godzilla)
...
![](/home/derwillezurmacht/Documents/Blog/you-guys-who-are-you.github.io/assets/images/offline-incremental-scc/slideshow.gif)

<div style="text-align:center"><img src="/assets/images/offline-incremental-scc/slideshow.gif" /></div>
