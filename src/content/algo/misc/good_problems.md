Note: I created this list on 2026/04/30, and retrospective inclusion of problems (that were solved by me in the past) will obviously select for different things relative to the problems I solve hereafter. I must also stress that this list isn't ordered by any metric (including solve date or quality).
